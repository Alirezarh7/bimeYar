    ...
    <form className="flex flex-col h-full">
      <div className="flex-1 space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-end">
          <div>
            <label className="text-sm font-medium text-gray-700 mb-1 block">پلاک</label>
            <PlateInput />
          </div>
          <div>
            <label htmlFor="plateName" className="text-sm font-medium text-gray-700 mb-1 block">
              نام پلاک
            </label>
            <input
              id="plateName"
              ...
              className="w-full p-3 h-12 border border-gray-300 rounded-lg focus:ring-1 focus:ring-primary focus:border-primary"
            />
          </div>
        </div>

        <div>
          <label className="text-sm font-medium text-gray-700 mb-1 block">صاحب پلاک</label>
          <div className="grid grid-cols-2 gap-4">
            <input
              type="text"
              placeholder="نام"
              className="p-3 h-12 border border-gray-300 rounded-lg"
            />
            <input
              type="text"
        ...
        <div>
          <label className="text-sm font-medium text-gray-700 mb-1 block">تاریخ تولد</label>
        ...
        <div>
          ...
          <div className="flex gap-6 mt-2 p-3">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="radio" name="gender" className="form-radio text-primary h-4 w-4 focus:ring-primary"/> زن
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="radio" name="gender" className="form-radio text-primary h-4 w-4 focus:ring-primary"/> مرد
              </label>
          </div>
        </div>
      </div>

      <div className="mt-8 pt-6 border-t grid grid-cols-2 gap-4 sticky bottom-0 bg-gray-50 -mx-6 -mb-6 px-6 py-4">
        <button
          type="button"
          onClick={onClose}
